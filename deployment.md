...
* `LATEST_CHANGES`: Used by the GitHub Action [latest-changes](https://github.com/Werefa-org/werefa-api) to automatically add release notes based on the PRs merged. It's a personal access token, read the docs for details.
